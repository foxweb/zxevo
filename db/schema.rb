...
ActiveRecord::Schema.define(version: 2014_01_25_204834) do
  ...
  create_table "rails_admin_histories", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.text "message"
    t.string "username"
    t.integer "item"
    t.string "table"
